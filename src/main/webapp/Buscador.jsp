<%-- 
    Document   : Buscador
    Created on : Dec 3, 2020, 7:33:56 PM
    Author     : CARLOS
--%>
...
<%
    List<Noticias> NoticiasResultados = (List<Noticias>) request.getAttribute("NewsDebajo");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
      ...
      <div class="Destacados container-fluid">
            <div class="row row-cols-1 row-cols-md-3">
                <%
                    for (Noticias Noticias : NoticiasResultados) { 
    ...
    <script>
        ...
        var valor2 = <%= NoticiasResultados.size()%>;
