 ...
 * @author CARLOS
 */
@WebServlet(name = "BuscadorController", urlPatterns = {"/BuscadorController"})
public class BuscadorController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String busca = request.getParameter("Botonbusca");
        List<Noticias> news6 = NoticiasDAO.getNoticias(busca);
